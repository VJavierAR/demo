        ...
        if self.x_studio_estado_capturas=='Listo':
            ...
            for rs in self.x_studio_contratos:
                ...
                if rs.x_studio_cobrar_contrato :
                    ...
                    a= self.env['account.move'].create({'x_studio_captura':self.id,'partner_id':self.cliente.id,'month':self.mes,'year':str(self.anio),'periodo':mes +' de '+str(anio) ,'company_id':id})
